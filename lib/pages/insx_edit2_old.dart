...
class InsxEdit2Old extends StatefulWidget {
  final InsxSQLiteModel? insxModel2;
  final bool? fromMap;
  InsxEdit2Old({Key? key, this.insxModel2, this.fromMap}) : super(key: key);

  @override
  _InsxEdit2OldState createState() => _InsxEdit2OldState();
}

class _InsxEdit2OldState extends State<InsxEdit2Old> {
